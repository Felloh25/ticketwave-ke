        ...
        <div className="bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Log in to keep discovering amazing events.
            </p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-white/10 text-white py-3 rounded-full text-sm font-medium hover:bg-white/5 transition disabled:opacity-50 disabled:cursor-not-allowed">
